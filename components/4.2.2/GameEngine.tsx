...
const GameEngine: React.FC<Props> = ({ onBack }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-[#F0FDF4]">
      ...
      <div className="absolute top-8 right-8 text-right opacity-20 pointer-events-none select-none">
          <h2 className="text-4xl font-black text-green-900/60">CHAPTER 4.2.2</h2>
          <span className="font-mono text-green-800/60 tracking-widest">DERIVED STATE</span>
      </div>
    </div>
  );
};
