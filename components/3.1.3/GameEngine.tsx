  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-[#E0F2F1]">
      ...
      <div className="absolute top-8 right-8 text-right opacity-20 pointer-events-none select-none">
          <h2 className="text-4xl font-black text-teal-900/60">CHAPTER 3.1.3</h2>
          <span className="font-mono text-teal-800/60 tracking-widest">SCROLL CONTROL</span>
      </div>
    </div>
  );
};
