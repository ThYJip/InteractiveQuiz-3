...
const DialogLayer: React.FC<Props> = ({ speaker, text, onNext, canProceed, isLastStep, onHome }) => {
    ...
    switch (speaker) {
      ...
      case 'Chi':
        return { 
            ...
            text: 'text-teal-600', 
            icon: <Cat size={20} className="text-teal-500" /> 
        };
      default:
  ...
  return (
    <div className="fixed bottom-6 left-4 right-4 z-50 flex justify-center pointer-events-none">
      <div className="relative w-full max-w-4xl bg-white rounded-[2rem] p-8 pb-10 shadow-[0_20px_50px_-12px_rgba(45,212,191,0.4)] border border-teal-100 pointer-events-auto">
